...
public class NaiveBayes_tokenizer {
    private static final Pattern WHITESPACE_PATTERN = Pattern.compile("\\s+");


    private Map<String, Integer> vocab;
    private Map<Integer, String> idToToken;
    private final int maxLength = ModelTypes.NaiveBayes_SEQ_LEN;
    private static final String TAG = "NaiveBayes Tokenizer";
    ...
    public NaiveBayes_tokenizer(InputStream tokenizerJsonStream) {
        this.vocab = new HashMap<>();
        this.idToToken = new HashMap<>();
        try {
            loadTokenizer(tokenizerJsonStream);
        } catch (JSONException e) {
            Log.e(TAG, "Naive tokenizer: ", e);
        }
    }
    ...
    public NaiveBayes_tokenizer.TokenizedResult encode(String textA) {
        ...
        return new NaiveBayes_tokenizer.TokenizedResult(inputIds);
    }
