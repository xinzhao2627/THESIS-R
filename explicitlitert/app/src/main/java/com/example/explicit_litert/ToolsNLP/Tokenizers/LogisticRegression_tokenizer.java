...
public class LogisticRegression_tokenizer {
    private static final Pattern WHITESPACE_PATTERN = Pattern.compile("\\s+");


    private Map<String, Integer> vocab;
    private Map<Integer, String> idToToken;
    private final int maxLength = ModelTypes.LogisticRegression_SEQ_LEN;
    private static final String TAG = "LogisticRegression Tokenizer";
    ...
    public LogisticRegression_tokenizer(InputStream tokenizerJsonStream) {
        this.vocab = new HashMap<>();
        this.idToToken = new HashMap<>();
        try {
            loadTokenizer(tokenizerJsonStream);
        } catch (JSONException e) {
            Log.e(TAG, "lin reg tokenizer: ", e);
        }
    }
