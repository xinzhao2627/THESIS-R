...
import com.example.explicit_litert.ToolsNLP.Tokenizers.Mobilebert_tokenizer;
...
public class Mobilebert_Detector {
    ...
    Mobilebert_tokenizer tokenizer;
    SoftmaxConverter softmaxConverter;
    public static final String[] LABELS = ModelTypes.MOBILEBERT_LABELARRAY;
    public static final String tokenizerPath = ModelTypes.MOBILEBERT_TOKENIZER;
    public static final String modelPath = ModelTypes.MOBILEBERT_MODEL;
    int[][] ids;
    int[][] mask;
    int[][] tokenType;
    float[][] outputs;
...
//            }//
            ...
            tokenizer = new Mobilebert_tokenizer(inputStream);
        } catch (Exception e) {
...
//        Log.i(TAG, "this for loop took: " + duration + " ms");
    ...
    public void initBuffers() {
        ids = new int[1][ModelTypes.MOBILEBERT_SEQ_LEN];
        mask = new int[1][ModelTypes.MOBILEBERT_SEQ_LEN];
        tokenType = new int[1][ModelTypes.MOBILEBERT_SEQ_LEN];
